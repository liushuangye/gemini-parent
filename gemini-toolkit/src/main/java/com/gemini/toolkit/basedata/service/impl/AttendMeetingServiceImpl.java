...
import com.gemini.toolkit.basedata.service.AttendMeetingService;
...
@Service
public class AttendMeetingServiceImpl extends AbsDataImport implements AttendMeetingService {
    ...
    public void afterImportData(HSSFWorkbook wookbook, String templateType, String dbType) {
        ...
        // 获取要特殊处理得sheet名
        // 组织人员
        String sheetName = CommonConsts.ATTEND_MEETINGSHEET;
