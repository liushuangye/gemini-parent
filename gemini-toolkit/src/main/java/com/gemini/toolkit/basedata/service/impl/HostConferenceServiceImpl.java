...
import com.gemini.toolkit.basedata.service.HostConferenceService;
...
public class HostConferenceServiceImpl extends AbsDataImport implements HostConferenceService {
    @Override
    ...
    public void afterImportData(HSSFWorkbook wookbook, String templateType, String dbType) {
        ...
        // 获取要特殊处理得sheet名
        // 组织人员
        String sheetName = CommonConsts.HOST_CONFERENCESHEET;
