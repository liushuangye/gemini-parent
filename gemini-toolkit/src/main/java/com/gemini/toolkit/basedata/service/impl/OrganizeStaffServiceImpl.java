...
@Slf4j
@Service
public class OrganizeStaffServiceImpl extends AbsDataImport implements OrganizeStaffService {
	private static final Logger log = LoggerFactory.getLogger(OrganizeStaffServiceImpl.class);
	@Autowired
	...
	public void afterImportData(HSSFWorkbook wookbook, String templateType, String dbType) {
		...
		// 获取要特殊处理得sheet名
		// 组织人员
		String[] sheetName = CommonConsts.ORGANIZERS_STAFFSHEET.split("\\,");
