...
import com.gemini.toolkit.basedata.service.SoftwareCopyrightLZYService;
...
public class SoftwareCopyrightLZYServiceImpl extends AbsDataImport implements SoftwareCopyrightLZYService {
    @Override
    ...
    public void afterImportData(HSSFWorkbook wookbook, String templateType, String dbType) {
        ...
        // 获取要特殊处理得sheet名
        // 组织人员
        String sheetName = CommonConsts.SOFTWARE_COPYRIGHT_LZYSHEET;
