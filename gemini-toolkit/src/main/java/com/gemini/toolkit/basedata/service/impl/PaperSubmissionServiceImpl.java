...
import com.gemini.toolkit.basedata.service.PaperSubmissionService;
...
@Service
public class PaperSubmissionServiceImpl extends AbsDataImport implements PaperSubmissionService {
    @Override
    ...
    public void afterImportData(HSSFWorkbook wookbook, String templateType, String dbType) {
        ...
        // 获取要特殊处理得sheet名
        // 组织人员
        String sheetName = CommonConsts.PAPER_SUBMISSIONSHEET;
            ...
            for (int i = 16; i < sheet.getLastRowNum() + 1; i++) {
                ...
                if (CommonConsts.INSERT.equals(updateFlg)) {
                    ...
                    for (int m = 2; m < lastCellNum - 1; m++) {
                        ...
                        if ("FUND_NUMBER".equalsIgnoreCase(filed)) {
