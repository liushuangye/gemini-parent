...
import com.gemini.toolkit.basedata.service.NewDrugCertificateService;
...
@Service
public class NewDrugCertificateServiceImpl extends AbsDataImport implements NewDrugCertificateService {
    @Override
    ...
    public void afterImportData(HSSFWorkbook wookbook, String templateType, String dbType) {
        ...
        // 获取要特殊处理得sheet名
        // 组织人员
        String sheetName = CommonConsts.NEW_DRUG_CERTIFICATESHEET;
