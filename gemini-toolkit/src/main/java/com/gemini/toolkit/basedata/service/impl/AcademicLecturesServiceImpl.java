...
import com.gemini.toolkit.basedata.service.AcademicLecturesService;
import com.gemini.toolkit.common.utils.*;
...
@Service
@Slf4j
public class AcademicLecturesServiceImpl extends AbsDataImport implements AcademicLecturesService {
    @Override
    ...
    public void afterImportData(HSSFWorkbook wookbook, String templateType, String dbType) {
        ...
        // 获取要特殊处理得sheet名
        // 组织人员
        String sheetName = CommonConsts.ACADEMIC_LECTURESSHEET;
