...
import com.gemini.toolkit.basedata.service.ResearchReportService;
import com.gemini.toolkit.common.utils.*;
...
@Slf4j
@Service
public class ResearchReportServiceImpl extends AbsDataImport implements ResearchReportService {
    @Override
    ...
    public void afterImportData(HSSFWorkbook wookbook, String templateType, String dbType) {
        ...
        // 获取要特殊处理得sheet名
        // 组织人员
        String sheetName = CommonConsts.RESEARCH_REPORTSHEET;
