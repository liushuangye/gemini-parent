...
import com.gemini.toolkit.basedata.service.AppraisalResultsService;
...
public class AppraisalResultsServiceImpl extends AbsDataImport implements AppraisalResultsService {
    @Override
    ...
    public void afterImportData(HSSFWorkbook wookbook, String templateType, String dbType) {
        ...
        // 获取要特殊处理得sheet名
        // 组织人员
        String sheetName = CommonConsts.APPRAISAL_RESULTSSHEET;
